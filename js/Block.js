function Block(fallingLane, color, iter, distFromHex, settled) {
	...
	this.fallingLane = fallingLane;
		...
		this.checked=0;
	//the angle at which the block falls — dynamic for any polygon
	var _sides = (typeof MainHex !== 'undefined' && MainHex.sides) ? MainHex.sides : 6;
	this.angle = 90 - ((180 / _sides) + (360 / _sides) * fallingLane);
